...
<div class="container">
  <a class="navbar-brand" href="index.html">Visite Gouin</a>
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavId">
      <ul class="navbar-nav me-auto mt-2 mt-lg-0">
          ...
          <li class="nav-item">
              <a class="nav-link" href="#">Link al mas allá</a>
          </li>
          <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownId">
                  <a class="dropdown-item" href="visitantes.html">nos han visitado</a>
                  <a class="dropdown-item" href="#">Aningun lado????</a>
              </div>
          </li>
      </ul>
